...
\end{lstlisting}
  ...
  Seven facts become three clauses. The system invents a fresh
  predicate named \texttt{exception\_\{head\}\_\{guard\}} to hold the
  two exceptions. The compression is accepted because one rule plus
  two exceptions is shorter than seven facts.
